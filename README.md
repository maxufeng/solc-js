...
```bash
npm install @bifproject/solc-bif
```

### Usage on the Command-Line

If this package is installed globally (`npm install -g @bifproject/solc-bif`), a command-line tool called `solcjs` will be available.
...
```javascript
var solc = require('@bifproject/solc-bif');
...
```javascript
var solc = require('@bifproject/solc-bif');
const smtchecker = require('@bifproject/solc-bif/smtchecker');
const smtsolver = require('@bifproject/solc-bif/smtsolver');
...
The `linker` module (`require('solc-bif/linker')`) offers helpers to accomplish this.

The `linkBytecode` method provides a simple helper for linking:

```javascript
var linker = require('@bifproject/solc-bif/linker');
...
```javascript
var abi = require('@bifproject/solc-bif/abi');
...
```
var translate = require('@bifproject/solc-bif/translate')
