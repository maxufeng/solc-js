...
```bash
npm install solc-bif
```

### Usage on the Command-Line

If this package is installed globally (`npm install -g solc-bif`), a command-line tool called `solcjs` will be available.
...
```javascript
var solc = require('solc-bif');
const smtchecker = require('solc-bif/smtchecker');
const smtsolver = require('solc-bif/smtsolver');
...
```javascript
var linker = require('solc-bif/linker');
